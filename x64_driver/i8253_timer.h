...
#define X86_PORT_TIM1_CH0_COUNT_REG     (X64_PORT_TIMER1 + 0)
#define X86_PORT_TIM1_CH1_COUNT_REG     (X64_PORT_TIMER1 + 1)
#define X86_PORT_TIM1_CH2_COUNT_REG     (X64_PORT_TIMER1 + 2)
#define X86_PORT_TIM1_CONTORL_REG       (X64_PORT_TIMER1 + 3)
